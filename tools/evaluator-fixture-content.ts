  ...
  invariantGates: [
    {
      ...
      affectedCategoryIds: ["checkpoint", "playability"],
    ...
    },
    {
      ...
      outcomeEffect: "fail",
      requiredEvidenceKinds: ["route-graph"],
      affectedMetricIds: ["checkpoint.topology-validity"],
      affectedCategoryIds: ["checkpoint"],
      dependencyScope: "declared",
    },
    {
      ...
      outcomeEffect: "fail",
      requiredEvidenceKinds: ["finish-topology"],
      affectedMetricIds: ["finish.topology-validity"],
    ...
    },
    {
      ...
      affectedCategoryIds: ["checkpoint", "hazard", "playability", "policy"],
      dependencyScope: "declared",
    },
    {
    ...
    },
    {
      ...
      outcomeEffect: "fail",
      requiredEvidenceKinds: ["route-graph"],
      affectedMetricIds: ["policy.evidence-completeness"],
      affectedCategoryIds: ["policy"],
      dependencyScope: "declared",
    },
    {
      ...
      outcomeEffect: "fail",
      requiredEvidenceKinds: ["geometry-fact"],
      affectedMetricIds: ["policy.decorative-collision-violations"],
      affectedCategoryIds: ["policy"],
      dependencyScope: "declared",
    },
  ],
