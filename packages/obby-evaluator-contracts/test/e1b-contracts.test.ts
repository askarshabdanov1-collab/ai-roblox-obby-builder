  ...
  it.each([
    ...
    [
      "coarse-transition-state",
      {
        ...
        reproduction: { methodId: "coarse-transition-v1", inputHashes: [] },
      },
    ],
    [
      "checkpoint-topology",
    ...
    [
      "softlock-candidate",
      {
        ...
        candidateId: "softlock.checkpoint01",
        subjectObjectId: "Checkpoint01",
        candidateKind: "checkpoint-without-outgoing-path",
        state: "structural-softlock-candidate",
        reproduction: { methodId: "softlock-candidate-v1", inputHashes: [] },
      },
    ],
